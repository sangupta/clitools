 ...
 *
 */
@Command(name = "ver", description = "Display the OS version")
public class Version implements CliTool {

	public static void main(String[] args) {
		String osName = System.getProperty(SystemPropertyNames.OS_NAME);
		String osVersion = System.getProperty(SystemPropertyNames.OS_VERSION);
